  ...
  <Dropdown placement="bottomLeft" :overlayClassName="`${prefixCls}-dropdown-overlay`">
    <span :class="[prefixCls, `${prefixCls}--${theme}`]" class="flex">
      ...
      <span :class="`${prefixCls}__info hidden md:block`">
        ...
        {{ getUserInfo.deptName }} {{ getUserInfo.userName }}({{ getUserInfo.userCode }})
        </span>
      </span>
    </span>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const getUserInfo = computed(() => {
        const { userName = '', headPic, userRemark,userCode,deptName,companyName } = userStore.getUserInfo || {};
        return { userName, avatar: headPic|| headerImg, userRemark ,userCode,deptName,companyName};
      });
