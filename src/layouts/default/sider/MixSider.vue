...
<script lang="ts">
  ...
  import { SimpleMenu, SimpleMenuTag } from '/src/components/SimpleMenu';
  ...
  import { SIDE_BAR_MINI_WIDTH, SIDE_BAR_SHOW_TIT_MINI_WIDTH } from '/src/enums/appEnum';
  import clickOutside from '/src/directives/clickOutside';
  import { getChildrenMenus, getCurrentParentPath, getShallowMenus } from '/src/router/menus';
