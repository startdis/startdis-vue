...
import { BasicDrawer } from '/src/components/Drawer';
...
import { AppDarkModeToggle } from '/src/components/Application';

import { MenuTypeEnum, TriggerEnum } from '/src/enums/menuEnum';
